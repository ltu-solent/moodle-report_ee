...
class report_submitted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' submitted the external examiner report for the course with id '$this->courseid'.";
    }
    ...
    public static function get_name() {
        return get_string('reportsubmitted', 'report_ee');
    }
